...
export const mockTemplates: Template[] = [
  {
    // d3b07384-d113-4c9f-a2e6-ebcd2a2f8c5b
    id: 'd3b07384-d113-4c9f-a2e6-ebcd2a2f8c5b',
    title: 'Hợp đồng nhượng quyền thương mại',
    description:
      'Biểu mẫu hợp đồng nhượng quyền thương mại chuẩn chỉnh, áp dụng cho các chuỗi nhượng quyền bán lẻ và dịch vụ.',
    category: 'Hợp đồng',
    usageCount: 1450,
    isNew: true,
    isVip: false,
    ...
    fields: [
      {
        ...
        inputs: [
          ...
          {
            key: 'idIssueInfo',
            label: 'Ngày cấp, nơi cấp CCCD',
            type: 'text',
            defaultValue: '01/01/2019, UBND Huyện ABC, Đà Nẵng',
            required: true
          },
          {
            key: 'currentAddress',
        ...
        inputs: [
          {
            ...
            label: 'Số hợp đồng',
            type: 'text',
            defaultValue: '12345678901112345',
            required: true
          },
  ...
  },
  {
    ...
    description:
      'Biểu mẫu CF401A-02 để đăng ký thành lập doanh nghiệp tư nhân theo quy định của Sở Kế hoạch và Đầu tư.',
    ...
    fields: [
      {
        ...
        inputs: [
          {
            key: 'ownerName',
            label: 'Họ và tên chủ doanh nghiệp',
            type: 'text',
      ...
      },
      {
        ...
        inputs: [
          {
            key: 'businessName',
            label: 'Tên doanh nghiệp viết bằng tiếng Việt',
            type: 'text',
            defaultValue: 'DOANH NGHIỆP TƯ NHÂN THƯƠNG MẠI A',
            required: true
          },
          {
            key: 'officeAddress',
            ...
            type: 'text',
            defaultValue: '123 Nguyễn Hữu Thọ, Hải Châu, Đà Nẵng',
            required: true
          },
  ...
  },
  {
    ...
    description:
      'Mẫu hợp đồng thuê văn phòng làm việc dành cho các doanh nghiệp, quy định rõ ràng trách nhiệm bên thuê và bên cho thuê.',
    category: 'Hợp đồng',
    usageCount: 2100,
    isNew: false,
    isVip: true,
        ...
        inputs: [
          {
            ...
            type: 'text',
            defaultValue: 'Công ty Quản lý Bất động sản OfficeLand',
            required: true
          },
          {
            key: 'lessorAddress',
            label: 'Địa chỉ',
            type: 'text',
            defaultValue: '456 Lê Lợi, Hải Châu, Đà Nẵng',
            required: true
          }
        ]
      },
  ...
  },
  {
    ...
    description:
      'Đơn xin nghỉ phép chuẩn dành cho nhân viên văn phòng, cán bộ công chức theo đúng quy định hành chính.',
    category: 'Hành chính',
    usageCount: 520,
    isNew: true,
    isVip: false,
    ...
    fields: [
      {
        ...
        inputs: [
          {
            key: 'fullName',
            label: 'Họ và tên người viết đơn',
            type: 'text',
          ...
          },
          {
            ...
            type: 'text',
            defaultValue: 'Hành chính - Nhân sự',
            required: true
          },
      ...
      },
      {
        ...
        inputs: [
          ...
          { key: 'endDate', label: 'Đến hết ngày', type: 'date', defaultValue: '2026-06-22', required: true },
          {
            ...
            type: 'text',
            defaultValue: 'Giải quyết công việc gia đình',
            required: true
          }
        ]
      },
  ...
  },
  {
    ...
    description:
      'Mẫu biên bản ghi nhận việc bàn giao tài sản, trang thiết bị giữa các cá nhân, bộ phận trong doanh nghiệp.',
    category: 'Biên bản',
    usageCount: 680,
    isNew: false,
    isVip: false,
    ...
    fields: [
      {
        ...
        inputs: [
          ...
          { key: 'handoverDate', label: 'Ngày bàn giao', type: 'date', defaultValue: '2026-06-16', required: true },
          {
            ...
            type: 'text',
            defaultValue: 'Văn phòng Công ty, Tầng 5, Tòa nhà A',
            required: true
          }
        ]
      },
      {
        ...
        inputs: [
          ...
          },
          {
            ...
            type: 'text',
            defaultValue: 'Trưởng bộ phận Kho',
            required: true
          }
        ]
      },
      ...
      },
      {
        ...
        inputs: [
          {
            key: 'assetName',
            label: 'Tên tài sản bàn giao',
            type: 'text',
            defaultValue: 'Laptop Dell Latitude 5420 kèm sạc',
            required: true
          },
          {
            key: 'assetStatus',
            ...
            type: 'text',
            defaultValue: 'Mới 95%, hoạt động bình thường',
            required: true
          }
        ]
      }
