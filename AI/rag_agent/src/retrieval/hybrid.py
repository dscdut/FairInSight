...
async def retrieve(
    ...
    *,
    ...
    # Candidate pool: lấy top_k * 3 (18 ứng viên khi top_k=6) để Cross-Encoder Rerank chọn ra 6 kết quả xuất sắc nhất
    pool = top_k * 3 if settings.RERANK_ENABLED else top_k * 2
